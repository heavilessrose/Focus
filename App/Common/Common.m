...
//
//   The kCommandKeyAuthRightDesc strings here contain Focus as as shortcut for 
...
+ (NSDictionary *)commandInfo
{
    ...
    dispatch_once(&sOnceToken, ^{
        sCommandInfo = @{
                NSStringFromSelector(@selector(focus:blockedHosts:withReply:)) : @{
                kCommandKeyAuthRightName    : @"BradJasper.focus.focus",
                kCommandKeyAuthRightDefault : @kAuthorizationRuleClassAllow,
                kCommandKeyAuthRightDesc    : NSLocalizedString(
                    @"Focus is trying to unfocus",
                    @"prompt shown when user is required to authorize to focus"
                )
            },
                NSStringFromSelector(@selector(unfocus:withReply:)) : @{
                kCommandKeyAuthRightName    : @"BradJasper.focus.unfocus",
                kCommandKeyAuthRightDefault : @kAuthorizationRuleClassAllow,
                kCommandKeyAuthRightDesc    : NSLocalizedString(
                    @"Focus is trying to unfocus",
                    @"prompt shown when user is required to authorize to unfocus"
                )
            },
                NSStringFromSelector(@selector(uninstall:withReply:)) : @{
                kCommandKeyAuthRightName    : @"BradJasper.focus.uninstall",
                kCommandKeyAuthRightDefault : @kAuthorizationRuleClassAllow,
                kCommandKeyAuthRightDesc    : NSLocalizedString(
                    @"Focus is trying to uninstall",
